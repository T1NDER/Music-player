...
### 📚 О проекте
**Music Player** — это интерфейс музыкального плеера, реализованный в виде простого лендинга. Проект представляет собой адаптацию готового дизайна: основной упор сделан на корректную реализацию вёрстки, соблюдение визуальной иерархии и точное соответствие макету.
...
P.S: Для более удобного просмотра сайта предоставлена ссылка на GitHub Pages: 🔗[GitHub Pages](https://t1nder.github.io/Music-player/)
